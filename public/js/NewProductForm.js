export function NewProductForm(){
  ...
  // function ValidationsProductForm (d,formValues) {
  function ValidationsProductForm () {

    const $form = d.getElementById('new-product-form'),
    ...
    $form.addEventListener('keyup', (e) => {
      if(e.target.matches('#new-product-form [required]')) {
        let $input = e.target,
  ...
  setTimeout(() => ValidationsProductForm(d,formValues),0)
}